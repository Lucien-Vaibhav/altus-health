...
import { FaFacebookF, FaGoogle, FaTwitter, FaInstagram, FaPinterest } from "react-icons/fa";
  ...
  return (
    <footer className="bg-gray-100 text-gray-700 pt-10 pb-8">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        {/* Main Footer Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-6 md:mt-10">
          {/* Logo & Socials */}
          <div className="text-center md:text-left">
            <Image src="/logo-blue.png" alt="Patholab Logo" width={180} height={50} className="mx-auto md:mx-0" />
            <p className="text-sm mt-3">Patholab laboratory is a well-equipped lab that provides the best services.</p>
            <div className="flex justify-center md:justify-start space-x-3 mt-4">
              {[FaFacebookF, FaGoogle, FaTwitter, FaInstagram, FaPinterest].map((Icon, index) => (
                <div key={index} className="w-10 h-10 flex items-center justify-center bg-gray-100 rounded-lg shadow-sm transition-all duration-300 hover:bg-[#0071DC] group cursor-pointer">
          ...
          <div className="text-center md:text-left">
            ...
            <Image src="/line-title.png" alt="Wavy Underline" width={35} height={35} className="mx-auto md:mx-0 mt-1" />
            ...
            <ul className="mt-3 text-sm space-y-2">
              {[
                ...
                <li key={index} className="flex justify-between text-gray-700">
                  <span>{day}</span>
                  <span className={day === "Sunday" ? "text-blue-500 font-medium" : "text-gray-500"}>{time}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 bg-white rounded-lg p-6 mt-6 md:mt-10 text-gray-900 text-center md:text-left">
          <div className="flex flex-col md:flex-row items-center md:items-start space-x-4 mb-4 md:mb-0">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start space-x-4">
            ...
            <span className="font-semibold text-gray-900">183 Marina Avenue, Miami Ci Mall, USA</span>
          </div>
        </div>

        {/* Footer Bottom */}
        <div className="mt-6 md:mt-10 pt-6 grid grid-cols-1 md:grid-cols-3 text-center text-sm text-gray-600 gap-4">
          <div>© 2023, <span className="text-blue-500 font-medium">BRAVISTHEME</span>. All rights reserved.</div>
