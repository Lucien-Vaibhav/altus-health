...
export default function LatestResearch() {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      Array.from(containerRef.current.children), // Convert HTMLCollection to an array
      { opacity: 0, y: 50 },
      ...
      <div className="container mx-auto px-2">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 mt-3 text-lg">
            We have world-class pathologists & lab assistants, equipped with the
            best laboratory machinery & reagents.
          </p>
        </div>
        <div ref={containerRef} className="flex flex-wrap justify-center gap-4">
          ...
          {researchData.map((item, index) => (
            <div
              key={index}
              className="bg-white shadow-xl rounded-2xl overflow-hidden p-6 w-[450px] h-[600px] flex flex-col"
            >
              {/* Image Wrapper */}
              ...
              <div className="flex-1 flex flex-col justify-between mt-3">
                ...
                <a
                  href="#"
                  className="text-gray-500 font-medium flex items-center gap-2 text-md mt-2"
                >
                  READ MORE <span>↗</span>
                </a>
              </div>
