...
export default function Hero() {
  ...
  return (
    <section
      className="relative w-full bg-[#EAF2FF] py-20 px-6 md:px-12 lg:px-24 overflow-hidden"
      style={{
        background: "radial-gradient(circle at 20% 50%,#FFF,#c3e0fe)",
      }}
    >
      <div className="max-w-7xl h-[600px] mx-auto flex flex-col-reverse md:flex-row items-stretch gap-20">
        {/* Left Side - Image with Rotating Circle */}
        <div
          ref={leftSectionRef}
          className="relative md:w-1/2 flex items-center justify-center h-full"
        >
          ...
          <div className="absolute top-[2%] left-[15%] mb-[30px] w-[550px] h-[750px]">
            <Image
              src="/man.png"
              alt="Smiling Man"
              width={500}
              height={500}
              className="h-full w-full max-w-[500px] object-contain"
              priority
            />
          </div>
        </div>
        ...
        >
          ...
          <p
            className="text-[#6f7f90] mt-4 text-xl"
          ...
          <div className="mt-8 bg-transparent border-2 border-white shadow-lg flex items-stretch relative rounded-br-[60px] px-1">
            ...
            <div className="flex-[1] py-5 px-7 relative border-r border-gray-200 bg-white">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-[#1e73be] text-white px-8 py-2 rounded-full text-sm font-bold">
                50% OFF
              </div>
              <div className="flex flex-row gap-4 items-center justify-center h-full">
                <p className="text-[32px] font-extrabold text-[#1e73be]">
                  $500
                </p>
                <div className="relative">
                  <span
                    className="text-[#6f7f90] text-[32px] font-extrabold relative inline-block"
            ...
            <div className="flex-1 py-5 px-7 border-l border-white bg-transparent">
              <div className="flex items-center gap-3 h-full pl-4">
                ...
                <div className="flex flex-col">
                  <p className="text-[34px] font-extrabold text-[#1d2864]">
                    30
                  </p>
